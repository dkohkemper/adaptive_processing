% LMS_7_LMF
%   [K, W_VEC] = lms_7_lmf(D_VAR, U_VEC, W_INIT, MU, TOL, ITER_MAX) solves problem
%   min_{w}E[|d-uw|^{2}]
%
...
% Date:         November, 2019
% *************************************************************************
function [idx_k, w_vector, error_vec, min_val_vec] = lms_7_lmf(d_var, u_vec, w_init, mu, tol, iter_max)
