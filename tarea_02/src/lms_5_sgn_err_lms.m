% LMS_5_SGN_ERR_LMS
%   [K, W_VEC] = lms_5_sgn_err_lms(D_VAR, U_VEC, W_INIT, TOL, ITER_MAX) solves problem
%   min_{w}E[|d-uw|^{2}]
%   
...
%
% *************************************************************************
function [idx_k, w_vector, error, min_val] = lms_5_sgn_err_lms(d_var, u_vec, w_init_vec, tol, iter_max)
